...
public class PixelInspectorWidget extends JPanel implements MouseListener {
	...
	// creates labels for each pixel inspector aspect
	...
	public void mouseClicked(MouseEvent e) {
		// gets X and Y of the values in the Picture
		int x = e.getX();
		int y = e.getY();
		xLabel.setText("X: " + x);
		yLabel.setText("Y: " + y);
		...
		// method is used to round the value to 100's place
